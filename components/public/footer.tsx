...
function FacebookIcon({ className }: { readonly className?: string }) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full max-w-lg">
              ...
              >
                <Input
                  ...
                  required
                  className="border-white/30 bg-white/10 text-white placeholder:text-white/70 focus-visible:ring-white"
                />
                <Input
                  type="email"
