-- =============================================================================
-- 006: Content — Hero Images, Legal Documents, Commitment Migration, Lectures
-- =============================================================================
-- Idempotent: safe to run multiple times.
-- DEPENDS ON: Prisma init migration (legal_documents, document_acceptances,
--             commitment_acknowledgements tables must exist)
-- Covers: hero image updates, legal document seeds (commitment/T&Cs/privacy),
--         commitment acknowledgement migration, and lecture seeds for C2-C10.
-- =============================================================================
...
-- Set course images to gray BG
UPDATE courses SET "imageUrl" = '/images/LT_grayBG.png';

-- Set standalone module images to gray BG (short courses)
UPDATE modules
...
-- Set package images to green BG
UPDATE hybrid_packages SET "imageUrl" = '/images/LT_greenBG.png';

-- ============================================================
-- Seed: Legal Documents (Commitment, Terms & Conditions, Privacy Policy)
-- ============================================================

INSERT INTO "legal_documents" (
  "id", "slug", "title", "content", "version", "isActive",
...
-- ============================================================
-- Migrate: commitment_acknowledgements → document_acceptances
-- Run after legal documents are seeded above.
-- ============================================================

INSERT INTO document_acceptances (
    "id", "studentId", "documentId", "documentSlug", "documentVersion",
    "ipAddress", "userAgent", "acceptedAt"
)
SELECT
    'da_' || ca.id,
    ca."studentId",
