...
const TERMS_CONTENT = [
  ...
  },
  {
    ...
    content:
      "All content on the Life Therapy website, portal, courses, and digital products — including text, images, videos, branding, and course materials — is the intellectual property of Life Therapy and may not be copied, reproduced, distributed, or shared without prior written consent. Course materials and digital products are licensed for your personal use only.",
  },
  {
    heading: "10. Online Courses & Digital Products",
    content:
      "Access to courses and digital products is granted upon purchase and is for the registered account holder only. Course progress is tracked in your portal. We reserve the right to update course content at any time. Sharing, reselling, or redistributing course materials is prohibited.",
  },
  {
    heading: "11. Gift Vouchers & Promotional Credits",
    content:
      "Gift vouchers are valid for the period stated at time of purchase. Gifted credits are non-refundable and non-transferable for cash. Promotional or complimentary credits may be subject to additional conditions as communicated at the time of issue.",
  },
  {
    heading: "12. Limitation of Liability",
    content:
      "To the maximum extent permitted by South African law, Life Therapy shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of our services. Our total liability for any claim shall not exceed the amount you paid in the 6 months preceding the claim. Life Therapy is not responsible for technical issues with Microsoft Teams, internet connectivity, or third-party services beyond our control.",
  },
  {
    heading: "13. Dispute Resolution",
    content:
      "If you have a complaint or dispute, please contact us first at hello@life-therapy.co.za. We will endeavour to resolve any issue within 14 business days. If we cannot resolve the matter informally, the dispute shall be referred to mediation before any legal proceedings. These Terms are governed by the laws of the Republic of South Africa, and any legal proceedings shall be subject to the jurisdiction of the Western Cape High Court.",
  },
  {
    heading: "14. Force Majeure",
    content:
      "Life Therapy shall not be liable for any failure or delay in performing our obligations due to circumstances beyond our reasonable control, including but not limited to: load shedding, internet service interruptions, natural disasters, pandemic restrictions, or government-imposed regulations.",
  },
  {
...
const DOCUMENTS = [
  { slug: "commitment", title: "My Commitment to You", content: COMMITMENT_CONTENT },
  { slug: "terms", title: "Terms & Conditions", content: TERMS_CONTENT },
...
async function main() {
  ...
  for (const doc of DOCUMENTS) {
    await prisma.legalDocument.upsert({
      where: { slug_version: { slug: doc.slug, version: 1 } },
      create: {
        slug: doc.slug,
        title: doc.title,
        content: doc.content as unknown as import("../lib/generated/prisma/client").Prisma.InputJsonValue,
        version: 1,
        isActive: true,
