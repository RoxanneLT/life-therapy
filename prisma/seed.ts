  ...
  await prisma.pageSection.createMany({
    data: [
      ...
      },
      {
        ...
        ctaLink: "/book?type=free_consultation",
        sortOrder: 7,
      },
    ],
  });
  ...
  await prisma.pageSection.createMany({
    data: [
      ...
      },
      {
        ...
        config: {
          items: [
            { icon: "Sparkles", title: "Free Consultation", description: "30-minute introductory call", price: "Free", priceNote: "no obligation", ctaText: "Book a Consultation", ctaLink: "/book?type=free_consultation", highlight: true },
            { icon: "Video", title: "Individual Session", description: "60-minute 1:1 video call", price: "R850", priceNote: "per session", ctaText: "Book a Session", ctaLink: "/book?type=individual" },
            { icon: "Users", title: "Couples Session", description: "60-minute couples video call", price: "R1,200", priceNote: "per session", ctaText: "Book a Session", ctaLink: "/book?type=couples" },
          ],
