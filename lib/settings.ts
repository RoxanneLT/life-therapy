...
export async function getSiteSettings() {
  ...
  if (!settings) {
    return {
      ...
      sessionPriceIndividualZar: null,
      sessionPriceIndividualUsd: null,
      sessionPriceIndividualEur: null,
      sessionPriceIndividualGbp: null,
      sessionPriceCouplesZar: null,
      sessionPriceCouplesUsd: null,
      sessionPriceCouplesEur: null,
      sessionPriceCouplesGbp: null,
      createdAt: new Date(),
      updatedAt: new Date(),
