...
export async function getSiteSettings() {
  ...
  if (!settings) {
    return {
      ...
      whatsappSessionReminders: true,
      whatsappBillingReminders: true,
      whatsappCreditReminders: true,
      creditExpiryDays: null,
      sessionPriceIndividualZar: 85000,
      sessionPriceIndividualUsd: 6500,
      sessionPriceIndividualEur: 5900,
      sessionPriceIndividualGbp: 4900,
      sessionPriceCouplesZar: 120000,
      sessionPriceCouplesUsd: 9500,
      sessionPriceCouplesEur: 8500,
      sessionPriceCouplesGbp: 7500,
      createdAt: new Date(),
      updatedAt: new Date(),
