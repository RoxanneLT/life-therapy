 ...
 *
 * PORTED from the sibling project (pleks) on 2026-08-20, with its hook — `dev-standards`
 * `playbooks/3-TOKEN-ECONOMY.md` tier 1. The harness facts it rests on were established there and
 * are harness-scoped, not project-scoped, so they inherit on this machine and would need re-running
 * on a new one.
 *
 ...
 */
import { WARN, STOP, CACHE_READ_MULTIPLIER, contextNow, loadState } from "./hooks/context-budget.js";
